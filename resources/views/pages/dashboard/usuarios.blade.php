  ...
  <div class="space-y-8">
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
      ...
      <div class="flex items-center space-x-6 text-sm">
        ...
        <div class="text-center">
          <div class="text-2xl font-bold text-purple-600">{{ $usuarios->where('role.name', 'administrator')->count() }}
          </div>
          <div class="text-gray-500">Administradores</div>
        </div>
        <div class="text-center">
          <div class="text-2xl font-bold text-green-600">{{ $usuarios->where('role.name', 'student')->count() }}
          </div>
      ...
      <div
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 mt-2">{{ $usuarios->where('role.name', 'administrator')->count() }}
            </p>
            <div class="flex items-center mt-2">
      ...
      <div
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 mt-2">{{ $usuarios->where('role.name', 'student')->count() }}
            </p>
            <div class="flex items-center mt-2">
      ...
      <div class="p-4">
        <form id="userForm" method="POST" action="{{ route('dashboard.usuarios.store') }}" class="space-y-2">
          ...
          <fieldset class="flex justify-center gap-2">
            <x-ui.button type="button" class="text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl p-2"
              onclick="closeModal()">
              Cancelar
            </x-ui.button>
